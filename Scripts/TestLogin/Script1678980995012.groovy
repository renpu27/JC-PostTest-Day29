...
WebUI.setText(findTestObject('Object Repository/Page_My Account  ToolsQA Demo Site/input__username'), 'renpu-27')

WebUI.setEncryptedText(findTestObject('Object Repository/Page_My Account  ToolsQA Demo Site/input__password'), 'zx70Thx/QzWt503zTniWaA==')
...
WebUI.verifyElementText(findTestObject('Dashboard'), 'Dashboard')
